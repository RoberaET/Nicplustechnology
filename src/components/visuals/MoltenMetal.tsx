...
const MoltenMetal: React.FC<MoltenMetalProps> = ({
  ...
  useEffect(() => {
    ...
    ubg[0] = bg[0];  ubg[1] = bg[1];  ubg[2] = bg[2];
  }, [
    color1, color2, color3, speed, scale, detail, glow, coreSize,
    swirl, fold, blackPoint, brightness, colorMode, grain, grainIntensity,
    mouseInteraction, mouseStrength, opacity, backgroundColor, lightMode
  ]);
